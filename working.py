...
def get_investment_rec(risk_level):
    """
    Returns an investment recommendation observing risk profile.
    """
    risk_levels = {
    ...
    if age is not None:
        ...
        if age < 0:
            return build_validation_result(
                False,
                "age",
                "invalid entry!, can you provide an age greater than zero?",
            )
        elif age >= 65:
            return build_validation_result(
                False,
...
def recommend_portfolio(intent_request):
    ...
    initial_rec = get_investment_rec(risk_level)
